...
'''
ref:
4/2/2023 ref. https://pythonprogramming.net/tensorflow-object-detection-api-self-driving-car/
...
#
# date          who         what
# 4/2/2023      Ron King    - initial testing with ssd mobilenet v1 code from Sentdex channel
#                             (object-detection-api-self-driving-car)
...
'''
### Keep this as reference for later use with mouse/keyboard controls
